...
<body>
    <div class="container mt-4">
        <h1 class="mb-4">Formulário de Alteração de Alunos</h1>
        <form action="{{ route('aluno.update', $aluno->id) }}" method="POST"> <!-- Passo o valor da variável $id -->
            ...
            <div class="mb-3">
                ...
                <input type="text" name="celular" id="celular" class="form-control" value="{{ $aluno->celular }}" required>
            </div>

            <div class="mb-3">
                <label for="catCNH" class="form-label">Categoria CNH</label>
                <input type="text" name="catCNH" id="catCNH" class="form-control" value="{{ $aluno->catCNH }}" required>
            </div>
